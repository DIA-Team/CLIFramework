...
class TableTest extends TestCase
{
    public function testNumberFormatCell()
    {
        ...
        $table->addRow(["AAA", "ASCII adjust AL after addition", 123]);
        $table->addRow(["AAD", "ASCII adjust AX before division", 222]);
        $table->addRow(["AAM", "ASCII adjust AX after multiplication", 12909]);
    ...
    public function testColumnCellAttribute()
    {
        ...
        $table->addRow(["AAA", "ASCII adjust AL after addition"]);
        $table->addRow(["AAD", "ASCII adjust AX before division"]);
        $table->addRow(["AAM", "ASCII adjust AX after multiplication"]);
