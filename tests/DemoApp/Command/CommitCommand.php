    ...
    public function arguments($args)
    {
        $args->add('user')
          ->validValues(function () {
              ...
              $values->group('admins', 'Administrators', ['admin1', 'admin2', 'admin3']);
              $values->group('users', 'Users', ['userA', 'userB', 'userC']);
        ...
        $args->add('repo')
          ->validValues(['CLIFramework', 'GetOptionKit', 'PHPBrew', 'AssetKit', 'ActionKit']);
